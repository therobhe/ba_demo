...
# remove again
from implementations import relay_heating
from implementations import samsung_tv
from implementations import dc_motor_fan
from implementations import light_sensor
from implementations import temperature_humidity_sensor
from implementations import philipshue
from implementations import thermostat
...
def extractSensorInfo():
    ...
    def buildMQTTMessage(retVal):
        for keys in retVal:
            ...
            if (keys == 'temperature'):
                answer = "Temperature: " + str(retVal[keys])
            if (keys == 'humidity'):
                answer = "Humidity: " + str(retVal[keys])
